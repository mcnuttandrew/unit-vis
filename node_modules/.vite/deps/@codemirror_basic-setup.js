import { A as CharCategory, B as Text, D as Annotation, E as RangeValue, F as Prec, G as findColumn, H as codePointSize, I as StateEffect, K as fromCodePoint, L as StateField, M as EditorState, N as Facet, O as ChangeDesc, P as MapMode, R as Transaction, T as RangeSetBuilder, U as countColumn, V as codePointAt, W as findClusterBreak, _ as highlightSpecialChars, a as Direction, c as PluginField, f as WidgetType, g as highlightActiveLine, h as dropCursor, i as Decoration, j as EditorSelection, k as ChangeSet, m as drawSelection, o as EditorView, r as BlockType, u as ViewPlugin, v as keymap, w as RangeSet, x as runScopeHandlers, z as combineConfig } from "./dist-CPoZapM3.js";
import { S as NodeProp, _ as indentString, b as syntaxTree, f as foldable, g as indentOnInput, i as IndentContext, m as getIndentation, p as getIndentUnit, t as defaultHighlightStyle, v as indentUnit, y as language } from "./dist-B9jVJ70J.js";
import { o as hoverTooltip, r as completionKeymap, t as autocompletion } from "./dist-CV6fO-GE.js";
//#region node_modules/@codemirror/history/dist/index.js
...
//#endregion
//#region node_modules/@codemirror/gutter/dist/index.js
/**
...
var baseTheme$6 = /*@__PURE__*/ EditorView.baseTheme({
	".cm-gutters": {
		display: "flex",
		height: "100%",
...
function gutters(config) {
	let result = [gutterView, baseTheme$6];
...
var gutterView = /*@__PURE__*/ ViewPlugin.fromClass(class {
	...
	syncGutters(detach) {
		...
		for (let line of this.view.viewportLineBlocks) {
			...
			} else text = line.type == BlockType.Text ? line : void 0;
			if (!text) continue;
...
//#endregion
//#region node_modules/@codemirror/fold/dist/index.js
...
var foldState = /*@__PURE__*/ StateField.define({
	...
	update(folded, tr) {
		...
		for (let e of tr.effects) if (e.is(foldEffect) && !foldExists(folded, e.value.from, e.value.to)) folded = folded.update({ add: [foldWidget.range(e.value.from, e.value.to)] });
...
function foldGutter(config = {}) {
	...
	let markers = ViewPlugin.fromClass(class {
		...
		update(update) {
			if (update.docChanged || update.viewportChanged || update.startState.facet(language) != update.state.facet(language) || update.startState.field(foldState, false) != update.state.field(foldState, false) || syntaxTree(update.startState) != syntaxTree(update.state)) this.markers = this.buildMarkers(update.view);
		}
		buildMarkers(view) {
...
//#endregion
//#region node_modules/@codemirror/matchbrackets/dist/index.js
...
//#endregion
//#region node_modules/@codemirror/basic-setup/node_modules/@codemirror/commands/dist/index.js
...
function cursorByPage(view, forward) {
	...
	view.dispatch(setSel(state, selection), { effects: startPos && startPos.top > scrollRect.top && startPos.bottom < scrollRect.bottom ? EditorView.scrollIntoView(selection.main.head, {
		y: "start",
...
var selectParentSyntax = ({ state, dispatch }) => {
	dispatch(setSel(state, updateSel(state.selection, (range) => {
		var _a;
...
//#endregion
//#region node_modules/@codemirror/closebrackets/dist/index.js
var defaults = {
	brackets: [
		"(",
		"[",
...
var skipBracketEffect = /*@__PURE__*/ StateEffect.define({ map(value, mapping) {
...
var definedClosing = "()[]{}<>";
function closing(ch) {
	for (let i = 0; i < 8; i += 2) if (definedClosing.charCodeAt(i) == ch) return definedClosing.charAt(i + 1);
...
//#endregion
//#region node_modules/@codemirror/panel/dist/index.js
...
*/
var showPanel = /*@__PURE__*/ Facet.define({ enables: [panelPlugin, baseTheme$3] });
//#endregion
...
//#endregion
//#region node_modules/@codemirror/basic-setup/node_modules/@codemirror/search/dist/index.js
...
//#endregion
//#region node_modules/@codemirror/comment/dist/index.js
/**
...
//#endregion
//#region node_modules/@codemirror/rectangular-selection/dist/index.js
var MaxOff = 2e3;
...
//#endregion
//#region node_modules/@codemirror/basic-setup/dist/index.js
/**
