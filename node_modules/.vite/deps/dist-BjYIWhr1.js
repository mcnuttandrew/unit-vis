import { C as NodeSet, E as Tree, S as NodeProp, T as Parser, w as NodeType, x as DefaultBufferLength } from "./dist-B9jVJ70J.js";
...
(function(Rec) {
	...
	Rec[Rec["CutDepth"] = 15e3] = "CutDepth";
	Rec[Rec["CutTo"] = 9e3] = "CutTo";
})(Rec || (Rec = {}));
var Parse = class {
	...
	advance() {
		...
		} else if (newStacks.length > 1) outer: for (let i = 0; i < newStacks.length - 1; i++) {
	...
	advanceStack(stack, stacks, split) {
		...
		if (stack.stack.length >= 15e3) while (stack.stack.length > 9e3 && stack.forceReduce());
...
//#endregion
export { ExternalTokenizer as n, LRParser as r, ContextTracker as t };
