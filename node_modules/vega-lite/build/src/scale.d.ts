...
export declare type Domain = (null | string | number | boolean | DateTime | SignalRef)[] | 'unaggregated' | SelectionExtent | SignalRef | DomainUnionWith;
...
export interface Scale<ES extends ExprRef | SignalRef = ExprRef | SignalRef> {
     ...
     */
    domain?: (null | string | number | boolean | DateTime | ES)[] | 'unaggregated' | SelectionExtent | DomainUnionWith | ES;
    /**
     ...
     */
    range?: RangeEnum | (number | string | number[] | ES)[] | {
        field: string;
    };
    /**
...
export declare const SCALE_PROPERTIES: ("reverse" | "round" | "base" | "zero" | "padding" | "type" | "range" | "nice" | "domain" | "domainMin" | "domainMax" | "domainMid" | "bins" | "interpolate" | "clamp" | "constant" | "exponent" | "paddingInner" | "paddingOuter" | "align" | "rangeMax" | "rangeMin" | "scheme")[];
export declare const NON_TYPE_DOMAIN_RANGE_VEGA_SCALE_PROPERTIES: ("reverse" | "round" | "base" | "zero" | "padding" | "nice" | "domainMin" | "domainMax" | "domainMid" | "bins" | "interpolate" | "clamp" | "constant" | "exponent" | "paddingInner" | "paddingOuter" | "align")[];
